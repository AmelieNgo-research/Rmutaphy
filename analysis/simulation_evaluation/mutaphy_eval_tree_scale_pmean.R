...
df_mutaphy_h1_n20_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n50_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n100_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n300_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n20_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n50_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n100_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n300_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n20_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n50_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n100_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n300_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 1,
  n = 300,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n20_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n50_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n100_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n300_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n20_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n50_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n100_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n300_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n20_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n50_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n100_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n300_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_H0_no_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue   }),
  true_label = 0,
  n = 300,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n20_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n50_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n100_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n300_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n20_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n50_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n100_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n300_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n20_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n50_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n100_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n300_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 1,
  n = 300,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n20_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n50_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n100_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n300_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n20_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n50_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n100_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n300_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n20_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n50_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n100_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n300_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_H0_noise, function(res) {     res$MutaPhy$tree$mean_corr_pvalue  }),
  true_label = 0,
  n = 300,
  Mtot = "50pct"
)
...
p <- auc_df %>%
  ...
  facet_grid(
    Noise ~ Mtot_label,
    labeller = labeller(
      Mtot_label = function(x) paste0("Mtot = ", x)
    )
  ) +
