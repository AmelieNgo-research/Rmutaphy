...
# Tree loading
tree_300 <- read.tree(here::here("analysis/Dengue_data/dengue_300.phy_phyml_tree.txt"))
...
# Viral sequences
library(seqinr)
sequences <- read.fasta(file = "analysis/Dengue_data/300_filtered_sequences.fasta", seqtype = "DNA")
...
dengue_site <- get_candidate_sites(nodes = 360,
                    tree = tree_300,
                    sequences = sequences,
                    verbose = TRUE)
