...
df_mutaphy_h1_n20_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n50_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n100_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n300_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n20_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n50_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n100_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n300_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n20_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n50_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n100_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n300_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 1,
  n = 300,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n20_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n50_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n100_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n300_Mtot1pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_H0_n20_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n50_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n100_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n300_Mtot10pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_H0_n20_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n50_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n100_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_H0_n300_Mtot50pct <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_H0_no_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)   }),
  true_label = 0,
  n = 300,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n20_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n50_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n100_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n300_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_h1_n20_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n50_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n100_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n300_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_h1_n20_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n50_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n100_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_h1_n300_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 1,
  n = 300,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n20_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot1pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 20,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n50_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot1pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 50,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n100_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot1pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 100,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n300_Mtot1pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot1pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 300,
  Mtot = "1pct"
)
...
df_mutaphy_h0_n20_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot10pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 20,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n50_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot10pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 50,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n100_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot10pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 100,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n300_Mtot10pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot10pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 300,
  Mtot = "10pct"
)
...
df_mutaphy_h0_n20_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n20_Mtot50pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 20,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n50_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n50_Mtot50pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 50,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n100_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n100_Mtot50pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 100,
  Mtot = "50pct"
)
...
df_mutaphy_h0_n300_Mtot50pct_noise <- data.frame(
  pvalue = sapply(res_all_n300_Mtot50pct_k20_H0_noise, function(res) {     mean(res$MutaPhy$subtree$permutation$pvalue)  }),
  true_label = 0,
  n = 300,
  Mtot = "50pct"
)
...
p <- auc_df %>%
  ...
  ylim(0, 1) +
  facet_grid(Noise ~ Mtot_label) + # Noise ~ Mtot_label Mtot_label ~ Noise
  theme_minimal(base_size = 14) +
  theme(
...
p <- auc_df %>%
  ...
  scale_shape_manual(values = c("MutaPhy" = 18, "AI" = 16, "PS" = 16,
                                "MC trait0" = 16, "MC trait1" = 16, "CRP-Tree" = 16)) ++
  scale_color_manual(values = named_colors) +
  labs(
    x = "Sample size (n)",
    y = "AUC"
